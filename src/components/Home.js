...
import Promotor from '../_img/cards/v2/Promoter.png'
    ...
    return (
            <div className='lg:grid grid-cols-2 my-[2.5rem] gap-12'>
                <div className='flex flex-col'>
                    ...
                    <img className='rounded-[6px] my-[2rem] w-[90%] lg:hidden mx-auto' src={Pioneer} alt='Pioneer Persona Card'></img>
                    <h3 className='mb-[1rem] mt-[1rem] header text-center lg:text-left'>The Personas:</h3>
                    <ul className='text-xl list-disc ml-[1.6rem]'>
                    <li className='mb-[1rem]'><b>Scholar</b>: Relating to education and scholarship.</li>
                        <li className='mb-[1rem]'><b>Advocate</b>: A person who publicly supports or recommends a particular cause or policy.</li>
                        <li className='mb-[1rem]'><b>Scientist</b>: A detailed examination of anything complex in order to understand its nature or to determine its essential features. </li>
                        <li className='mb-[1rem]'><b>Strategizer</b>: A person who buys and sells goods or assets for others.</li>
                        ...
                        <li className='mb-[1rem]'><b>Champion</b>: A person sent or authorized to represent others, in particular an elected representative sent to a conference.</li>
                        ...
                        <li className='mb-[1rem]'><b>Interpreter</b>: A messenger or representative, especially one on a diplomatic mission.</li>
                        <li className='mb-[1rem]'><b>General</b>: A commander of an army, or an army officer of very high rank.</li>
                        <li className='mb-[1rem]'><b>Playmaker</b>: An aggressively enterprising person; a go-getter.</li>
                        <li className='mb-[1rem]'><b>Pioneer</b>: A person who introduces new methods, ideas, or products.</li>
                        <li className='mb-[1rem]'><b>Striver</b>: An an unorthodox or independent-minded person.</li>
                        <li className='mb-[1rem]'><b>Mercenary</b>: Primarily concerned with making money at the expense of ethics.</li>
                        <li className='mb-[1rem]'><b>Promoter</b>: A worker, especially a skilled one.</li>
                        <li className='mb-[1rem]'><b>Negotiator</b>: A player in a team game who leads attacks or brings other players on the same side into a position from which they could score.</li>
                        <li className='mb-[1rem]'><b>Diplomat</b>: A a person who is professionally involved in politics, especially as a holder of or a candidate for an elected office.</li>
                        <li className='mb-[1rem]'><b>Navigator</b>: A medical practitioner qualified to practice surgery.</li>
                        <li className='mb-[1rem]'><b>Guardian</b>: A person who teaches others, source of information.</li>
                    </ul>
                </div>
                <div className='justify-self-end'>
                    <img className='rounded-[6px] w-[550px] mb-[5rem] hidden lg:block' src={Pioneer} alt='Pioneer Persona Card'></img>
                    <img className='rounded-[6px] w-[550px] mb-[5rem] hidden lg:block' src={Negotiator} alt='Negotiator Persona Card'></img>
                    <img className='rounded-[6px] w-[550px] mb-[5rem] hidden lg:block 2xl:hidden' src={Promotor} alt='Promoter Persona Card'></img>
                    <img className='rounded-[6px] w-[550px] mb-[5rem] hidden lg:block xl:hidden' src={Striver} alt='Striver Persona Card'></img>
                </div>
            </div>
    )
}